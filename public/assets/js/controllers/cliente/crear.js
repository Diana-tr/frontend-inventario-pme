...
const CrearClienteController = (() => {
    let form = null;
    let isSubmitting = false;

    async function init() {
        form = document.getElementById('form_crear_cliente');
        if (!form) return;
    ...
    async function handleFormSubmit(event) {
        ...
        isSubmitting = true;
        NotificationService.loading('Guardando cliente...');
        ...
        try {
            ...
            NotificationService.error('Ocurrió un error inesperado al guardar el cliente.');
            isSubmitting = false;
        }
    }
...
export default CrearClienteController;