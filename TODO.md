...
- [x] en las carpeta public\assets\js\controllers\usuario alli cree la estructura con sus archivos correspondientes y   lo mismo en public\assets\services tambien esta la estructura realizada. *(Asignado: Diana)*

- [x] estuve auditando y corrigiendo la parte del frontend. Ya quedó lista, estructurada y conectada:
...
Al hacer la prueba, la petición ya llega con éxito al backend, pero la API está respondiendo con un Error 500 (Internal Server Error) en el endpoint /api/v1/users/. ¿Me ayudas a revisar la terminal de Django para ver qué excepción está lanzando en el servidor y dejar listo el backend?. *(Asignado: Jhan)*
