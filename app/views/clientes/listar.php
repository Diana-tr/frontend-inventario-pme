                            ...
                            <div class="card card-outline card-primary shadow-sm">
                                <div class="card-header d-flex align-items-center">
                                    ...
                                    <div class="card-tools ml-auto">
                                        <a href="<?php echo $URL; ?>/categorias/crear" class="btn btn-primary btn-sm" data-permission="customers.create">
                                            <i class="fas fa-plus mr-1"></i> Registrar Nueva Cliente
                                        </a>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="cliente_modal_content" style="display: none;">
                        <div class="row align-items-center mb-4">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        <label class="text-muted small mb-0"><i class="fas fa-sitemap mr-1"></i>Cliente Padre</label>
            ...
            <div class="modal-content">
                ...
                <form id="formEditarCategoria" novalidate>
                    <div class="modal-body">
                        ...
                        <div id="edit_cliente_modal_loader" class="text-center py-5">
                        ...
                        <div id="edit_cliente_modal_content" style="display: none;">
                            <input type="hidden" id="edit_cliente_id" name="id_cliente">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    <label for="edit_parent_id" class="font-weight-bold small">Cliente Padre</label>
                                    <div class="select2-purple">
                                        <select class="select2" id="edit_parent_id" name="parent" data-placeholder="Seleccionar cliente padre" data-dropdown-css-class="select2-purple" style="width: 100%;">
                                ...
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    <textarea class="form-control" id="edit_description" name="description" rows="3" placeholder="Descripción del cliente"></textarea>
                                </div>

                                <div class="col-md-12 form-group mb-3">
                                    <div class="custom-control custom-switch mt-2">
                                        <input type="checkbox" class="custom-control-input" id="edit_is_active" name="is_active">
                                        <label class="custom-control-label font-weight-bold" for="edit_is_active">Cliente Activa</label>
                                    </div>
                                </div>
                            </div>
                        </div> <!-- Fin edit_cliente_modal_content -->
                    </div> <!-- Fin modal-body -->
