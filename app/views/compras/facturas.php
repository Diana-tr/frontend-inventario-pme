...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"><i class="fas fa-file-invoice-dollar mr-2"></i>Facturas de Compras</h1>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-outline card-primary shadow-sm">
                                ...
                                <div class="card-body">
                                    <table id="tbl_FacturasCompras" class="table table-bordered table-striped table-hover responsive nowrap" width="100%">
    ...
    <script type="module">
        ...
        import FacturaCompraController from "<?php echo $URL; ?>/public/assets/js/controllers/compra/facturas.js";

        document.addEventListener("DOMContentLoaded", async () => {
            await App.bootstrap();
            FacturaCompraController.init();
        });
    </script>
</body>
