...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col-12">
                            <div class="card card-outline card-primary shadow-sm">
                                <div class="card-header d-flex align-items-center">
                                    <h3 class="card-title font-weight-bold">Listado de Proveedores</h3>
                                    <div class="card-tools ml-auto">
                                        <a href="<?php echo $URL; ?>/proveedores/crear" class="btn btn-primary btn-sm" data-permission="suppliers.create">
                                            <i class="fas fa-plus mr-1"></i> Registrar Nuevo Proveedor
                                        </a>
                                    </div>
                                </div>

                                <div class="card-body">
                                    <table id="tbl_Proveedores" class="table table-bordered table-striped table-hover responsive nowrap" width="100%">
    ...
    <div class="modal fade" id="modalDetalleProveedor" tabindex="-1" role="dialog" aria-labelledby="modalDetalleProveedorLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-info text-white">
                    <h5 class="modal-title" id="modalDetalleProveedorLabel">
                        <i class="fas fa-tag mr-2"></i>Información Detallada del proveedor
                    </h5>
                ...
                <div class="modal-body">
                    <!-- Loader / Spinner -->
                    <div id="supplier_modal_loader" class="text-center py-5">
                    ...
                    <div id="supplier_modal_content" style="display: none;">
            ...
            <div class="modal-content">
                ...
                <form id="formEditarCliente" novalidate>
                    <div class="modal-body">
                        ...
                        <div id="edit_supplier_modal_loader" class="text-center py-5">
                            <div class="spinner-border text-warning" role="status" style="width: 3rem; height: 3rem;">
                                <span class="sr-only">Cargando...</span>
                            </div>
                            <p class="mt-2 text-muted font-weight-bold">Cargando información del proveedor...</p>
                        </div>

                        <!-- Campos del Formulario -->
                        <div id="edit_supplier_modal_content" style="display: none;">
                            <input type="hidden" id="edit_supplier_id" name="id_supplier">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group mb-3">
                                    <div class="custom-control custom-switch mt-2">
                                        ...
                                        <label class="custom-control-label font-weight-bold" for="edit_is_active">Proveedor Activo</label>
                                    </div>
                                </div>
                            </div>
                        </div> <!-- Fin edit_supplier_modal_content -->
                    </div> <!-- Fin modal-body -->
    ...
    <script type="module">
        ...
        import ProveedorListController from "<?php echo $URL; ?>/public/assets/js/controllers/proveedor/listar.js";
        ...
        document.addEventListener("DOMContentLoaded", async () => {
            ...
            $('#modalEditarProveedor').on('shown.bs.modal', function () {
