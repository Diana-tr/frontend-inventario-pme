...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col-md-12">
                            <div class="card card-primary shadow-sm">
                                <div class="card-header">
                                    <h3 class="card-title"><i class="fas fa-plus-circle mr-1"></i> Registrar Nueva Venta</h3>
                                </div>

                                <form id="form_crear_venta" autocomplete="off" novalidate>
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <textarea id="notes" name="notes" class="form-control" rows="2" placeholder="Notas opcionales sobre la venta..."></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3 align-items-end">
                                            ...
                                            <div class="col-md-3 form-group mb-0">
                                                <label for="add_price">Precio Unit. (Venta)</label>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped text-center" id="tabla_detalles_venta">
                                    ...
                                    <div class="card-footer d-flex justify-content-end bg-white">
                                        <a href="<?php echo $URL; ?>/ventas" class="btn btn-secondary mr-2">
                                            <i class="fas fa-times-circle mr-1"></i> Cancelar
                                        </a>
                                        <button type="submit" id="btn_guardar_venta" class="btn btn-primary font-weight-bold">
    ...
    <script type="module">
        ...
        import CrearVentaController from "<?php echo $URL; ?>/public/assets/js/controllers/venta/crear.js";

        document.addEventListener("DOMContentLoaded", async () => {
            await App.bootstrap();
            CrearVentaController.init();
        });
    </script>
</body>
