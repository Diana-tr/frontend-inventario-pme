...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"><i class="fas fa-shopping-cart mr-2"></i>Gestión de Ventas</h1>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card card-outline card-primary shadow-sm">
                                <div class="card-header d-flex align-items-center">
                                    <h3 class="card-title font-weight-bold">Historial de Ventas</h3>
                                    <div class="card-tools ml-auto">
                                        <a href="<?php echo $URL; ?>/ventas/crear" class="btn btn-primary btn-sm" data-permission="sales.create">
                                            <i class="fas fa-plus mr-1"></i> Registrar Nueva Venta
                                        </a>
                                    </div>
                                </div>

                                <div class="card-body">
                                    <table id="tbl_Ventas" class="table table-bordered table-striped table-hover responsive nowrap" width="100%">
            ...
            <div class="modal-content">
                <div class="modal-header bg-info text-white">
                    <h5 class="modal-title" id="modalDetalleVentaLabel">
                        <i class="fas fa-shopping-cart mr-2"></i>Información Detallada de la Venta
                    </h5>
                ...
                <div class="modal-body">
                    <!-- Loader / Spinner -->
                    <div id="sale_modal_loader" class="text-center py-5">
                    ...
                    <div id="sale_modal_content" style="display: none;">
                        <div class="row mb-4">
                            <!-- Info de Venta -->
                            <div class="col-md-4 border-right">
                                <h6 class="font-weight-bold text-uppercase text-muted border-bottom pb-2 mb-3">
                                    <i class="fas fa-info-circle mr-1"></i> Datos de Venta
                                </h6>
                                <p class="mb-1"><strong class="text-dark">ID Venta:</strong> #<span id="detail_sale_id"></span></p>
                            ...
                            <div class="col-md-4 border-right">
                                ...
                                <p class="mb-1 font-weight-bold text-primary" id="detail_customer_name">---</p>
                                <p class="mb-1"><strong class="text-dark">NIT/CC:</strong> <span id="detail_customer_document"></span></p>
                                <p class="mb-1"><strong class="text-dark">Correo:</strong> <span id="detail_customer_email"></span></p>
                                <p class="mb-1"><strong class="text-dark">Teléfono:</strong> <span id="detail_customer_phone"></span></p>
                            </div>
                        ...
                        <h6 class="font-weight-bold text-uppercase text-muted border-bottom pb-2 mb-3">
                            <i class="fas fa-box-open mr-1"></i> Productos Vendidos
                        </h6>
                ...
                <div class="modal-footer bg-light">
                    ...
                    <div id="sale_action_buttons" class="mr-auto"></div>
    ...
    <script type="module">
        ...
        import VentaListController from "<?php echo $URL; ?>/public/assets/js/controllers/venta/listar.js";

        document.addEventListener("DOMContentLoaded", async () => {
            await App.bootstrap();
            VentaListController.init();
        });
    </script>
</body>
